...
contract HookTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        rwa = new Hook{salt: salt}(IPoolManager(address(manager)), APP_ID, ACTION_ID);
        require(address(rwa) == hookAddress, "HookTest: hook address mismatch");
